 ...
 */
$APPLICATION->SetAdditionalCSS('//cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.3/fotorama.css');
$APPLICATION->AddHeadString('<script>!window.jQuery && document.write(unescape(\'%3Cscript src="//code.jquery.com/jquery-1.11.1.min.js"%3E%3C/script%3E\'))</script>',true);
$APPLICATION->AddHeadString('<script src="//cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.3/fotorama.js"></script>');
